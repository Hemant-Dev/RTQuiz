...
{
    /// <inheritdoc />
    public partial class quizv1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizSeries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizSeriesId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_QuizSeries_QuizSeriesId",
                        column: x => x.QuizSeriesId,
                        principalTable: "QuizSeries",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaderboardEntries_QuizSeries_QuizSeriesId",
                        column: x => x.QuizSeriesId,
                        principalTable: "QuizSeries",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Quizzes_ActiveQuizId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "GK" });

            migrationBuilder.InsertData(
                table: "QuizSeries",
                columns: new[] { "Id", "Description", "EndDate", "StartDate", "Title" },
                values: new object[] { 1, "Sample", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sample" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "PasswordHash", "Username" },
                values: new object[] { 1, "email", "password", "hemant" });

            migrationBuilder.InsertData(
                table: "Quizzes",
                columns: new[] { "Id", "CategoryId", "Description", "Difficulty", "Duration", "QuizSeriesId", "Title", "UserId" },
                values: new object[] { 1, 1, "Sample", 0, new TimeSpan(0, 0, 16, 40, 0), 1, "Sample", null });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "QuizId", "Text", "TimeLimit" },
                values: new object[] { 1, 1, "Question 1", new TimeSpan(0, 0, 8, 20, 0) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaderboardEntries_QuizSeriesId",
                table: "LeaderboardEntries",
                column: "QuizSeriesId");
