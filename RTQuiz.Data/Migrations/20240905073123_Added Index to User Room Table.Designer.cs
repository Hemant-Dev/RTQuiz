...
namespace RTQuiz.Data.Migrations
{
    ...
    [Migration("20240905073123_Added Index to User Room Table")]
    partial class AddedIndextoUserRoomTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RTQuiz.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "email",
                            PasswordHash = "lIeZR9+HCL0fhJ6xsxjYjO27c8bBP7vf0vfRMB72xGgmzqy/izf3JD5Oj1GyfKN9",
                            Username = "hemant"
                        });
                });
